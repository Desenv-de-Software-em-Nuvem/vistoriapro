...
import {
  UserPlus, UserX, ShieldCheck, ShieldOff, Search, Users,
  Edit3, X, Save, Building2,
} from 'lucide-react';
...
const AdminUsersPage: React.FC = () => {
  ...
  const handleDelete = async (user: User) => {
    const confirmed = await confirm({
      ...
      message: `Tem certeza que deseja excluir "${user.nome}"? Esta ação não pode ser desfeita.`,
